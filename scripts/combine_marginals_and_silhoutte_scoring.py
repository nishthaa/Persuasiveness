...
for dataname in datasets:
    for clfname in classifiers:
        ...
        outfile = open('/home/nimadaan/cmv/pythonwksp/src_v2/marginalssilhouettenormalizedscores/'+filename, 'w')
        ...
        for word in mu_dict:
            ...
            if word in sil_dict:
                sil = sil_dict[word]
            score = mu_dict[word] * sil
            print('Row',[word,mu_dict[word], sil, score])
