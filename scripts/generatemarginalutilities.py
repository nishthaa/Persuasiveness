...
for _classifier in CLASSIFIERS:
    ...
    for i in range(NUM_CYCLES):
        ...
        #Raw accuracy
        accuracy0 = nltk.classify.accuracy(classifier, testfeats)
        ...
        for word in get_all_words_from_feats(testfeats):
            ...
            _accuracy = nltk.classify.accuracy(classifier, _testfeats)
        ...
        outfile = open('/home/nimadaan/cmv/pythonwksp/src_v2/marginals/CORPS3_' + str(_classifier).split('(')[0] + '.csv', 'w')
